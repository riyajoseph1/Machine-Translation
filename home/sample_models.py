...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    #...
    rnn_1 = GRU(units, activation='relu', return_sequences=True, implementation=2, name='rnn_1')(input_data)
...
def final_model(input_dim, filters, kernel_size, conv_stride,
    ...
    # Batch Normalization
    bidir_rnn_normalized = BatchNormalization(name='bn_bidir_rnn')(bidir_rnn)
